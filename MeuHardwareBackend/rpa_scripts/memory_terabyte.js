...
const getIdData = () => {
   return new Promise((resolve, reject) => {
      connection.query("Select IFNULL(Max(id_data), 0) as id_data from Memory where store_name like 'Terabyte'",
       (err, res) => {
...
(async () => {
   ...
   await page.goto('https://www.terabyteshop.com.br/hardware/memorias');
