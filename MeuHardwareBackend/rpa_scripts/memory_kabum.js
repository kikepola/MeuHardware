...
const getIdData = () => {
   return new Promise((resolve, reject) => {
      connection.query("Select IFNULL(Max(id_data), 0) as id_data from Memory where store_name like 'Kabum'",
       (err, res) => {
...
(async () => {
   ...
   await page.goto('https://www.kabum.com.br/hardware/memoria-ram?pagina=1');
   ...
   while ( productsAvailable ){
      ...
      await page.goto('https://www.kabum.com.br/hardware/memoria-ram?pagina=' + i)      
      i++
