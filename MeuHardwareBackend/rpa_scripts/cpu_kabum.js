...
const getIdData = () => {
   return new Promise((resolve, reject) => {
      connection.query("Select IFNULL(Max(id_data), 0) as id_data from Processor where store_name like 'Kabum'",
       (err, res) => {
...
(async () => {
   ...
   await page.goto('https://www.kabum.com.br/hardware/processadores?pagina=1');
   ...
   while ( productsAvailable ){
      ...
      await page.goto('https://www.kabum.com.br/hardware/processadores?pagina=' + i)      
      i++
