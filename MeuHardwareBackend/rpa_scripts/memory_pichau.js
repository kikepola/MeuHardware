...
const getIdData = () => {
   return new Promise((resolve, reject) => {
      connection.query("Select IFNULL(Max(id_data), 0) as id_data from Memory where store_name like 'Pichau'",
       (err, res) => {
...
(async () => {
   ...
   await page.goto('https://www.pichau.com.br/hardware/memorias');
   ...
   while ( productsAvailable ){
      ...
      await page.goto('https://www.pichau.com.br/hardware/memorias?p=' + i)      
      i++
